...
// Usa as coleções já permitidas pelo Firebase do projeto original, mas separa
// todos os dados pelo campo projectId. Assim não mistura PEGABOBO e Elemental.
...
function openSpotDialogForNew(event){
  ...
  pendingSpot={...pointToPercent(event),mode:"new"}; els.spotCharacterSelect.value=characters[0].id; $("modalTitle").textContent="Adicionar Spot"; els.spotDialog.showModal();
}
...
initSelectors(); subscribeCharacters(); subscribeAllSpots();
